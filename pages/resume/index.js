    ...
    <>
      ...
      <div className="main-content">
        ...
        <div className="w-9/12 px-8 pb-10">
          ...
          {demoData.resume.awards && demoData.resume.awards.length > 0 (<AwardsComponent awards={demoData.resume.awards} />)}
          {demoData.resume.volunteering && demoData.resume.volunteering.length > 0 (<VolunteeringComponent volunteering={demoData.resume.volunteering} />  )}        
        </div>
      </div>
    </>
  );
